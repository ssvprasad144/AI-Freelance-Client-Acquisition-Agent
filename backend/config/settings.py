...
DISCOVERY_MODEL=os.getenv("DISCOVERY_MODEL","gpt-5.5"); DISCOVERY_MAX_RESULTS=int(os.getenv("DISCOVERY_MAX_RESULTS","20")); DISCOVERY_SEARCH_CONTEXT_SIZE=os.getenv("DISCOVERY_SEARCH_CONTEXT_SIZE","medium")
