...
DISCOVERY_QUERY_CACHE_TTL_HOURS=int(os.getenv("DISCOVERY_QUERY_CACHE_TTL_HOURS","72")); DISCOVERY_WORKER_INTERVAL=int(os.getenv("DISCOVERY_WORKER_INTERVAL","21600")); DISCOVERY_MAX_SEARCHES_PER_DAY=int(os.getenv("DISCOVERY_MAX_SEARCHES_PER_DAY","4")); DISCOVERY_TARGET_QUALIFIED_LEADS=int(os.getenv("DISCOVERY_TARGET_QUALIFIED_LEADS","10")); DISCOVERY_MIN_EXPLORATION_SEARCHES=int(os.getenv("DISCOVERY_MIN_EXPLORATION_SEARCHES","2")); DISCOVERY_LEARNING_LOOKBACK_DAYS=int(os.getenv("DISCOVERY_LEARNING_LOOKBACK_DAYS","30")); DISCOVERY_QUERY_VARIANT_MIN_SEARCHES=int(os.getenv("DISCOVERY_QUERY_VARIANT_MIN_SEARCHES","2")); DISCOVERY_MAX_EXCLUDED_DOMAINS=int(os.getenv("DISCOVERY_MAX_EXCLUDED_DOMAINS","8")); DISCOVERY_LOW_YIELD_THRESHOLD=float(os.getenv("DISCOVERY_LOW_YIELD_THRESHOLD","0.5")); DISCOVERY_SEARCH_CONTEXT_FALLBACK=os.getenv("DISCOVERY_SEARCH_CONTEXT_FALLBACK","true").lower()=="true"; DISCOVERY_PREFERRED_HOURS_ENABLED=os.getenv("DISCOVERY_PREFERRED_HOURS_ENABLED","false").lower()=="true"; DISCOVERY_PREFERRED_HOUR_START=int(os.getenv("DISCOVERY_PREFERRED_HOUR_START","8")); DISCOVERY_PREFERRED_HOUR_END=int(os.getenv("DISCOVERY_PREFERRED_HOUR_END","22")); DISCOVERY_SEMANTIC_REUSE_THRESHOLD=float(os.getenv("DISCOVERY_SEMANTIC_REUSE_THRESHOLD","0.62")); DISCOVERY_FRESHNESS_HOURS=int(os.getenv("DISCOVERY_FRESHNESS_HOURS","48")); DISCOVERY_DOMAIN_MIN_RESULTS=int(os.getenv("DISCOVERY_DOMAIN_MIN_RESULTS","8")); DISCOVERY_DOMAIN_BLOCK_QUALIFIED_RATE=float(os.getenv("DISCOVERY_DOMAIN_BLOCK_QUALIFIED_RATE","0.05"))
QUALIFICATION_MIN_SCORE=int(os.getenv("QUALIFICATION_MIN_SCORE","60")); LOCAL_PREFILTER_MIN_SCORE=int(os.getenv("LOCAL_PREFILTER_MIN_SCORE","40")); CRAWLER_MIN_LEAD_SCORE=int(os.getenv("CRAWLER_MIN_LEAD_SCORE","40")); AI_QUALIFICATION_MAX_LEADS_PER_CYCLE=int(os.getenv("AI_QUALIFICATION_MAX_LEADS_PER_CYCLE","8"))
...
FOLLOWUP_WORKER_INTERVAL=int(os.getenv("FOLLOWUP_WORKER_INTERVAL","60")); ACQUISITION_AUTOMATION_MODE=os.getenv("ACQUISITION_AUTOMATION_MODE","approval_required")
REVENUE_DEFAULT_CURRENCY=os.getenv("REVENUE_DEFAULT_CURRENCY","USD"); REVENUE_FX_RATES=os.getenv("REVENUE_FX_RATES","").strip(); DISCOVERY_SEARCH_UNIT_COST=float(os.getenv("DISCOVERY_SEARCH_UNIT_COST","0")); CRAWLER_UNIT_COST=float(os.getenv("CRAWLER_UNIT_COST","0")); AI_INPUT_COST_PER_1K=float(os.getenv("AI_INPUT_COST_PER_1K","0")); AI_OUTPUT_COST_PER_1K=float(os.getenv("AI_OUTPUT_COST_PER_1K","0")); OUTREACH_UNIT_COST=float(os.getenv("OUTREACH_UNIT_COST","0"))
OUTREACH_ENABLED=os.getenv("OUTREACH_ENABLED","false").lower()=="true"; OUTREACH_MAX_ATTEMPTS_PER_LEAD=int(os.getenv("OUTREACH_MAX_ATTEMPTS_PER_LEAD","3")); OUTREACH_MIN_DELAY_HOURS=float(os.getenv("OUTREACH_MIN_DELAY_HOURS","48")); OUTREACH_FROM_EMAIL=os.getenv("OUTREACH_FROM_EMAIL",""); SMTP_HOST=os.getenv("SMTP_HOST",""); SMTP_PORT=int(os.getenv("SMTP_PORT","587")); SMTP_USERNAME=os.getenv("SMTP_USERNAME",""); SMTP_PASSWORD=os.getenv("SMTP_PASSWORD",""); SMTP_USE_TLS=os.getenv("SMTP_USE_TLS","true").lower()=="true"
