    ...
    def handle(self,*args,**options):
        ...
        while True:
            ...
            try:
                ...
                self.stdout.write(self.style.SUCCESS("Discovery worker: profile={profile_id}, cached={cached}, discovered={discovered}, created={created}, analyzed={analyzed}, qualified={qualified}".format(**result)))
