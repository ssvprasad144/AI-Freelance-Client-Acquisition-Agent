...
def generate_proposal(lead,analysis)->str:
    ...
    client=OpenAI(api_key=settings.OPENAI_API_KEY)
    prompt={"profile":PROFILE,"lead":{"title":lead.title,"company":lead.company,"description":lead.description,"technologies":lead.technologies},"analysis":{"service_match":analysis.service_match,"matching_projects":analysis.matching_projects,"recommended_approach":analysis.recommended_approach}}
